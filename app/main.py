...
def _get_search_client():
    ...
    if _search_client is None:
        ...
        #           "AZURE_AI_SEARCH_INDEX", "memphis-311-index"
        #       ),
        #       credential=AzureKeyCredential(
...
def _get_doc_intel_client():
    """Lazily initialize the Azure Document Intelligence client."""
    ...
    if _doc_intel_client is None:
        ...
        #       ),
        #   )
        raise NotImplementedError("Configure the Document Intelligence client")
...
def main():
    ...
    result = {
        ...
        "metadata": {
            ...
            if hasattr(telemetry, "to_dict") else {},
        },
    }
    ...
    # Build design.json -- architecture decisions
    design = {
        "task": "memphis_311_platform",
        "architecture": {
            # TODO: Document your architecture decisions
            "pipelines": [],
            "routing_strategy": "",
            "safety_approach": "",
            "rationale": "",
